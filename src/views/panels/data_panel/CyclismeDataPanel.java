...
public class CyclismeDataPanel extends JPanel {
        private JTextField dureeTF;
        private JTextField distanceTF;
        private JButton confirmButton;
        private Controller controller;
        public CyclismeDataPanel(Controller controller) {
            ...
            setBorder(BorderFactory.createTitledBorder("Cyclisme"));
    ...
    private static class LoginInputListener implements ActionListener {
        ...
        private final CyclismeDataPanel form;
        public LoginInputListener(CyclismeDataPanel form, Controller controller) {
            this.controller = controller;
            this.form = form;
        }
        /**
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                if(form.getDistanceTF().getText().isBlank() || form.getDureeTF().getText().isBlank()) {
                    ...
                    Sport sport = sportDAO.findByName(SportEnum.CYCLISME.getValeur());
                    User user = controller.getCurrentUser();
                    String duree = form.getDureeTF().getText();
                    Float distance = Float.parseFloat(form.getDistanceTF().getText());
                    dataDAO.save(new DonneeCyclisme(sport, user, duree, distance, new Date()));
