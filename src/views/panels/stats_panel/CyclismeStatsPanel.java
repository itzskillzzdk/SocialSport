...
public class CyclismeStatsPanel extends JPanel {
    // leftPanel
    ...
    List<DonneeCyclisme> data;
    public CyclismeStatsPanel(Controller controller) {
        this.controller = controller;
        data = DataDAO.getInstance().getDataCyclisme(controller.getCurrentUser());
        init();
    }
    private void init() {
        ...
        sportPicture = new JLabel(Utils.getResizeImage("src/photo/Cyclisme.png",128, 128));
        ...
        sportJL = new JLabel(SportEnum.CYCLISME.getValeur());
